  ...
  return (
    <div className="book-description _container">
      <div className="book-description__content">
        <img src={image} className="book-description__image" />

        <div className="book-description__info">
          <Rating value={Number(rating)} className="book-description__rating" />
          <h1 className="book-description__title">{title}</h1>
          {subtitle && (
            <h2 className="book-description__subtitle">{subtitle}</h2>
          )}
          ...
          <ul className="book-description__info-list">
            ...
            <li className="book-description__info-item">Published: {year}</li>
            <li className="book-description__info-item">Pages: {pages}</li>
            <li className="book-description__info-item">ISBN-10: {isbn10}</li>
            <li className="book-description__info-item">ISBN-13: {isbn13}</li>
          </ul>
        ...
        <div className="book-description__wrapper-authors">
          ...
          <div className="book-description__wrapper-authors-names">
            <img src={DefaulImageAuthor} alt="Author's default image." />
            <h3 className="book-description__authors-names">{authors}</h3>
          </div>
      ...
      <div className="book-description__desc">
        <Title className="book-description__desc-title">Description</Title>
        <p>{desc}</p>
      </div>
    </div>
  );
